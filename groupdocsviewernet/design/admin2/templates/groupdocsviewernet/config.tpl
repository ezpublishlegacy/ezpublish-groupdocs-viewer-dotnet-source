<h3>Enter GroupDocs Viewer for .NET info</h3>
<div style="padding:10px;border:3px double gray;width:675px;">
	<form id="gdform" method="post" action={'groupdocsviewernet/config'|ezurl}>
	<table><tr>
		<td><span style="color:blue">URL for GroupDocs Viewer .NET:</span> </td>
...
<hr>
To <u>itegrate</u> GroupDocs Viewer for .NET on your website, just copy the <span style="color:red;font-weight:bold;">"Hook"</span>, paste it to any page and save it.
<hr>
...
{*List: {fetch( 'groupdocsviewernet', 'list', hash( 'as_object', true() ) )|attribute( 'show' )} - to use this just need to add functions in config.php*}
